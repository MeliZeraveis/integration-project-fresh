...
SELECT * FROM meli_fresh_test.inbound_order;
INSERT INTO inbound_order VALUES (1,'2023-01-25',1,1),
                                 (2,'2023-01-25',1,1),
                                 (3,'2023-01-25',3,2);

SELECT * FROM meli_fresh_test.batch_stock;
...
INSERT INTO purchase_order VALUES (1, 1, '2022-12-30', 'Aberto', 150),
                                  (2, 1, '2022-12-30', 'Finalizado', 450),
                                  (3, 1, '2022-12-30', 'Finalizado', 300),
                                  (4, 2, '2022-12-30', 'Finalizado', 150),
                                  (5, 2, '2022-12-30', 'Finalizado', 320),
                                  (6, 1, '2022-12-30', 'Finalizado', 450.77),
                                  (7, 2, '2022-12-30', 'Finalizado', 125.12),
                                  (8, 1, '2022-12-30', 'Finalizado', 1000.55),
                                  (9, 2, '2022-12-30', 'Finalizado', 150.88);
