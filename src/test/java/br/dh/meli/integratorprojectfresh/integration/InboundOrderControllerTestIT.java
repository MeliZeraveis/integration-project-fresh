...
public class InboundOrderControllerTestIT {
    private final String ROUTE = Routes.BASE_ROUTE + Routes.INBOUND_ORDER; 
    @Autowired
    ...
    @Test
    @DisplayName("Testa se o método post armazena os dados corretamente em caso de sucesso")
    ...
    @Test
    @DisplayName("Testa se o método put atualiza os dados corretamente em caso de sucesso")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o ORDERDATE é nulo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o ORDERDATE informado está incorreto")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando a data de fabricação está incorreta")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando a data de fabricação é nula")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o DUEDATE está incorreto")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o DUEDATE é nulo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o SectionCode é nulo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o WarehouseCode é nulo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o AnnouncementID é nulo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o SectionType é nulo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o ProductQuantity informado não atinge o valor mínimo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o ProductQuantity é nulo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o ManufacturinTime recebe um time com formato inválido")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o ManufacturingTime é nulo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o Volume é nulo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o Volume é menor que 1")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o PRICE é negativo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o PRICE é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o ORDERDATE é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o ORDERDATE recebe uma data invalida")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o ManufacturingDate recebe uma data invalida")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o ManufacturingDate é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o DueDate recebe uma data invalida")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o DueDate é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o SectionCode é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o WarehouseCode é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o AnnouncementId é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o SectionType é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o ProductQuantity declarado não atinge o valor mínimo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o ProductQuantity é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o ManufacturingTime recebe um time num formato inválido")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o ManufacturingTime é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o Volume é nulo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o Volume é menor que 1")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o Price é negativo")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção quando o Price é nulo")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção WAREHOUSE_NOT_FOUND quando o WarehouseCode é inválido")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção MANAGER_NOT_VALID quando o Manager não é valido")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção SECTION_NOT_FOUND quando o Section é inválido")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção INSERT_BATCH_SECTION_INCORRET quando o SectionType é incorreto")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção LIMIT_CAPACITY_SECTION quando a capacidade máxima de estoque é atingida")
    ...
    @Test
    @DisplayName("Testa se o método post retorna uma exceção quando o section não pertence à wahehouse")
    ...
    @Test
    @DisplayName("Testa se o método SAVE retorna uma exceção quando o DUEDATE tiver menos de 3 semanas")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção INBOUND_ORDER_NOT_FOUND quando o OrderNumber é inválido")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção BATCH_NOT_FOUND quando o BatchNumber é inválido")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção WAREHOUSE_NOT_FOUND quando o WareHouseNumber é inválido")
    void Update_ReturnExceptionNotFound_whenWareHouseNotExist_Fail() throws Exception {
        inboundOrderDTO.setOrderNumber(1L);
        batchStockList.get(0).setBatchNumber(1L);
        batchStockList.get(1).setBatchNumber(2L);
        inboundOrderDTO.setWarehouseCode(-1L);
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção MANAGER_NOT_FOUND quando o User não é gerente")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção ANNOUNCCEMENT_NOT_FOUND quando o Announcement não esta registrado")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção SECTOPM_NOT_FOUND quando a Section não esta registrado")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção INSERT_BATCH_SECTION_INCORRET quando o Section type está incorreto")
    ...
    @Test
    @DisplayName("Testa se o método put retorna uma exceção LIMIT_CAPACITY_SECTION quando o Volume ultrapassa o limite de capacidade")
    ...
    @Test
    @DisplayName(("Testa o método UPDATE se retorna uma EXCEPTION se o DUEDATE tiver menos de 3 semanas"))
